...
switch (xlFieldType) {
	...
	case 'VerifyText':
		xpath = '//*[text()=' + xlFieldLabel + ']'

		WebUI.callTestCase(findTestCase('Test Cases/CommonTestCases/verifyText'), [('xpath') : xpath,('xlFieldLabel'):xlFieldLabel], FailureHandling.STOP_ON_FAILURE)
