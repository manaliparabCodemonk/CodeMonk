@Recruiter
Feature: Recruiter Journeys - Create Recruiter, Login , Edit Profile Id and Password, Send Talent Invite

  Scenario: Create Recruiter
    
  	Given user launches "Codemonk" website for "Recruiter"
 	  When user creates email and password for "Recruiter"
    Then verify user is on "Talent-partner About You" page
    When user read the test data sheet "RecruiterSignUp" from file "CodemonkTestdata.xls"
  	#  
    ...
    And user enter details on "Company" on "Client" page
		And clicks on "Continue to dashboard" button and verify "Company" is completed
     
    Then verify user is on "Talent-partner Dashboard" page
  	And user logs out from application
  	And closes browser
    	
  Scenario: Login as Recruiter and Edit Profile
    
  	Given user launches "Codemonk" website
 	  When user enters username and password for "Recruiter"
 		#    
    ...
    And user selects "My profile"
    Then verify Profile Details are updated for "Recruiter"
   	And user logs out from application 	
  	And closes browser
  	##
   	Scenario: Login as Recruiter and Send an invite Client
    ...
    Then verify user is on "Talent-partner About You" page
  	...
  	And "Talent" launches new window for Complete Profile
    ...
    And user logs out from application 	
   	...
   	##
   	##
   Scenario: Login as Recruiter and Reset Password
    
  	Given user launches "Codemonk" website
 	  When user Reset password for "Recruiter"
    Then verify user is on "Talent-partner About You" page
 		#   
   	And user logs out from application 	
  	And closes browser